...
<head>
    <meta charset="UTF-8">
    <title>Pigment - Manage Organisers</title>
    <style>
        /* Shared CSS Logic */
...
<body>
    <div class="sidebar">
        ...
        <div class="sidebar-content">
            ...
            <a href="manage_organisers.php" style="color: var(--accent);">Manage Organisers</a>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><strong><?php echo htmlspecialchars($org['o_Name']); ?></strong></td>
                        <td><?php echo htmlspecialchars($org['o_Company']); ?></td>
                        <td><?php echo htmlspecialchars($org['o_email']); ?></td>
                        <td>
                            <a href="manage_organisers.php?delete=<?php echo $org['organiser_ID']; ?>" 
                               class="btn-delete"
                               onclick="return confirm('Confirm deletion? This removes all associated events.')">Delete</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
